...
require (
	...
	github.com/elastic/elastic-agent-client/v7 v7.0.0-20200709172729-d43b7ad5833a // indirect
	github.com/elastic/go-libaudit v0.4.0 // indirect
	github.com/elastic/go-libaudit/v2 v2.0.0-20200515221334-92371bef3fb8 // indirect
